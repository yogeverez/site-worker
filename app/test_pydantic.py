"""
Simple test script for Pydantic model configuration.
...
def test_pydantic_models():
    ...
    try:
        ...
        if "additionalProperties" in schema:
            logger.info(f"additionalProperties is set to: {schema['additionalProperties']}")
        else:
            logger.info("additionalProperties is not explicitly set in the schema")
